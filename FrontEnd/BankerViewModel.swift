...
class BankerViewModel: ObservableObject {
    @Published var email = ""
    ...
    init(mainViewViewModel: MainViewViewModel? = nil) {
        ...
        func validate() -> Bool {
            ...
            // Check that the email ends with "@casca.com"
            guard trimmedEmail.hasSuffix("@casca.com") else {
                errorMessage = "Please sign in with your Casca employee email."
                return false
            }
